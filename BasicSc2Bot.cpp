...
int BasicSc2Bot::CountUnits(const ObservationInterface* observation, UnitTypeID unit_type) {
    int count = 0;
...
bool BasicSc2Bot::IsStructure(const Unit& unit) {
...
void BasicSc2Bot::MorphLarva(const Unit *unit) {
    ...
    else if (minerals >= 25 && spawning_pool_count > 0 && food_cap - food_used > 0){
